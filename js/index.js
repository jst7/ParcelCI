var data = [{
    ...
    },
    {
        ...
        "desc": "Duneserá siempre considerada el gran triunfo de la imaginación que convirtió a Frank Herbert en uno de los grandes visionarios de la literatura universal. Hoy este gran clásico vuelve a estar de actualidad porque pronto inspirará una película y una serie de televisión dirigidas por Denis Villeneuve, el director deArrival yBlade Runner 2049. Es hora, pues, de reivindicar un libro mítico con esta edición para coleccionistas que reproduce las doce ilustraciones interiores, firmadas por el prestigioso ilustrador Sam Weber, de la aclamada edición estadounidense, conmemorativa del cincuenta aniversario deDune, de The Folio Society.La historia comienza a miles de años en el futuro, en un gran imperio galáctico dividido en cuasi-feudos controlados por familias nobles. La clave para el control del Imperio se encuentra en Arrakis, un planeta desértico también conocido como Dune. El protagonista de la historia es el joven Paul Atreides, heredero del ducado de la Casa de los Atreides. Su padre, Leto Atreides, recibe de pronto la orden de trasladarse a Arrakis, y Paul deberá enfrentarse, por un la...",
    ...
    },
    {
        ...
        "desc": "Se suponía que esta sería una de esas misiones de búsqueda de rutina en un planeta no colonizado. Pero cuando Kira Navárez, una xenobióloga, encuentra debajo de la superficie de este mundo una reliquia alienígena, su vida y el curso de la historia humana cambiarán para siempre. Su viaje para descubrir la verdad acerca de la civilización alienígena la llevará a las maravillas y pesadillas del primer contacto, batallas espaciales épicas por el destino de la humanidad, y los rincones más profundos de la galaxia.",
    ...
    },
    {
        ...
        "category": "Ciencia Ficción",
        "author": "J.J. BENITEZ",
        "desc": "Tal como afirma el propio J.J.Benítez, adelantar el argumento y la naturaleza de Caballo de Troya es quebrar el desconcertante misterio que encierran sus páginas. Podemos apuntar, eso sí, que para la elaboración de esta obra el autor se ha basado en una documentación real, depositada hace años en Estados Unidos. Una documentación que pone al descubierto multitud de datos nuevos sobre al figura y obra de Jesús de Nazaret. Podemos asegurar que -tal y como sospecha buena parte de la humanidad- las grandes potencias ocultan muchos de sus proyectos espaciales y militares, y Caballo de Troya es una prueba más de ello.",
    ...
    },
    {
        ...
        "category": "Ciencia Ficción",
        "author": "NEIL GAIMAN",
        "desc": "El viaje del (anti)héroe llevado a su máxima expresión. Una novela que en realidad es un billete para llevarnos de viaje por carreteras secundarias poco transitadas y paradas atípicas en sitios que transpiran misterio e historia, permitiéndonos conocer y conversar con una miscelánea de fascinantes personajes. Dioses antiguos, héroes mitológicosy figuras legendarias se dan cita en la obra narrativa más importante del extraordinario Neil Gaiman.",
    ...
    },
    {
        ...
        "author": "VV.AA.",
        "desc": "Un cautivador libro a todo color que transporta a sus lectores a la megalópolis futurista de Night City, el epicentro del vibrante RPG producido por CD Projekt Red. Todo lo que necesitas saber sobre la historia, los personajes y el mundo del largo tiempo esperado videojuego de los creadores de The Witcher.",
    ...
    },
    {
        ...
        "desc": "Tienes en tus manos la guía que necesitas para completar Pokémon Mundo Misterioso, Equipo de Rescate DX, la nueva entrega del remake del clásico juego de Nintendo, ahora actualizado con gráficos nuevos e incorporando algunas funciones online. Sumérgete en un mundo de aventuras y color mientras descubres el misterio de los cataclismos que amenazan el mundo Pokémon:terremotos, tormentas, fuertes nevadas y rescatas a tus amigos. En este libro descubrirás los mejores trucos, consejos y estrategias para para derrotar a tus enemigos con unas completas y detalladas descripciones de las mazmorras. Encontrarás las listas completas de objetos, talentos, códigos y tipos de Pokémon para disfrutar de este el juego. No esperes más y exprime al máximo la experiencia Pokémon Mundo Misterioso con esta guía.",
